...
class TCTrackplusTracker(SiameseTracker):
    def __init__(self, model):
        super(TCTrackplusTracker, self).__init__()
    ...
    def track(self, img, iter):
        ...
        best_score2 = score2[best_idx]
        if iter % 50 == 0 or best_score2 < 0.8:
            self.good_crop = self.get_subwindow(img, self.center_pos,
                                                cfg.TRACK.EXEMPLAR_SIZE,
                                                s_z, self.channel_average)
